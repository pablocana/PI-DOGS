...
/* const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/dogs`, {        //deploy (sustituimos)
...
// un breed pertenece a muchos temperamentos.
Breed.belongsToMany(Temperament, {through: "breed_temperament"});
// un temperamento pertenece a mucho breed.
